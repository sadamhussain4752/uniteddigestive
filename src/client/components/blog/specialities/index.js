...
const SpecialitesDetails = (props) => {
  ...
  useEffect(() => {
    if (routeParams.id) {
      let expertiseDetails = expertise.find((i) => i.id === parseInt(routeParams.id));
        ...
        <div className="container">
          <div className="row align-items-center inner-banner">
            <div className="col-md-12 col-12 text-center">
              <h2 className="breadcrumb-title">{expdetails && expdetails?.title}</h2>
...
export default SpecialitesDetails;
