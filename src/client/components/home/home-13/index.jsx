    ...
    <div className="main-wrapper home-pg-fourteen">
        ...
        <div className="container">
          ...
          <div className="row">
            <div className="col-md-12">
              <OwlCarousel {...ourNurse} className="top-nurse-profile-slider owl-carousel">
      ...
      <section className="neraby-nurses-sec">
        <div className="container">
          ...
          <div className="row">
            <div className="col-md-12">
              <OwlCarousel {...ourNurseSlide} className="nurse-profile-slider owl-carousel">
      ...
      <section className="our-blog-fourteen">
        ...
        <div className="container">
          ...
          <OwlCarousel {...ourBlog} className="blog-slide-fourteen owl-carousel">
            <div
