      ...
      <div className="container">
        <nav className="navbar navbar-expand-lg header-nav">
          ...
          <div className="main-menu-wrapper">
            ...
            <ul className="main-nav">
              ...
              <li className="has-submenu">
                <Link to="#">Doctors <i className="fas fa-chevron-down" /></Link>
              ...
              <li className="has-submenu">
                <Link to="#">Admin <i className="fas fa-chevron-down" /></Link>
                <ul className="submenu">
          ...
          <ul className="nav header-navbar-rht">
            <li className="login-in-fourteen"><Link to="/register"><ImageWithBasePath src="assets/img/icons/login-user-circle.svg" className="me-2" alt="Img" />Sign Up / </Link> <Link to="/login"> Sign In</Link></li>
          </ul>
        </nav>
      </div>
    </header>
